/* --- CONFIGURATION DES IMAGES (FINALISÉE) --- */
const assets = {
    bg: {
    ...
    char: {
        // IMAGE DE GROUPE
        tous_choques: "assets/tous_choques.png", 
        
        // La théière volante (Assumant theiere.png)
        ...
        // L'image de la mort d'Antoine (dead antoine.png) est utilisée comme image de la foule choquée dans cette fin.
...
const scenario = {
    ...
    // --- FIN 1 : MORT D'ANTOINE (THÉIÈRE VOLANTE ET GROUPE CHOC) ---
    fin_1_start: [
        ...
        // LA THÉIÈRE VOLANTE
        { speaker: "", text: "La théière d'Aymen s'envole, décrivant un arc parfait dans les airs !", char: "théiere" }, 
        { speaker: "", text: "Elle effectue son arc...", char: "théiere" }, 
        { speaker: "", text: "BAM.", char: null, bg: "noir", action: "flash" },
        
        // Image de groupe choqué (celle pointée par 'antoine_mort')
        { speaker: "", text: "Le directeur s'effondre. Tout le monde est choqué.", char: "antoine_mort", bg: "salle" }, 
    ...
    fin_2_start: [
        ...
        // IMAGE DE GROUPE CHOQUÉ (image générique)
        ...
        { speaker: "", text: "FIN 2 : Chérifa - Décès accidentel.", char: null, next: "score_recap" }
    ],
